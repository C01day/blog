...
$precision=$预测为1的数据中实际为1的比例$=\dfrac{true\;positive}{predicted\;positive}=\dfrac{true\;positive}{true\;positive+false\;positive}$

$recall=$实际为1的数据中真正被预测为1的比例$=\dfrac{true\;positive}{actual\;positive}=\dfrac{true\;positive}{true\;positive+false\;negative}$
